<?php
/**
 * Boxed Editorial Event Card Partial - v6.0
 */
...
<div class="ke-card-boxed ke-status-<?php echo esc_attr( strtolower( $status ) ); ?>">
	<div class="ke-card-img">
	...
	<div class="ke-card-body">
		...
		<div class="ke-card-meta">
			<div class="ke-card-date"><?php echo esc_html( $date ); ?> <?php if($time) echo ' | ' . esc_html($time); ?></div>
			<?php if ( $venue_name ) : ?>
