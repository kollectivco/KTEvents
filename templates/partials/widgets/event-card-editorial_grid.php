<?php
/**
 * Editorial Grid – Larger title, strong type hierarchy. Magazine-style.
 */
...
?>
<div class="ke-card ke-card-editorial">
	...
	<div class="ke-card-content">
		<h3 class="ke-card-title ke-editorial-title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3>
		<?php if ( $date || $venue_name ) : ?>
			<div class="ke-card-meta ke-editorial-meta">
